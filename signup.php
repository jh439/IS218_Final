...
<div class="form-group">
	...
	<div class="col-sm-9">
	<input type="date" id="birthDate" placeholder="Insert your Birthday" class="form control">
	<span class="help block"></span>
	</div>
 </div>
...
<div class="form-group">
	...
	<div class="col-md-4">
	<input id="textinput" name="textinput" placeholder="Insert Phone Number" class="form-control input-md" required="" type="text">
